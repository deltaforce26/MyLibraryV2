...
namespace MyLibraryV2.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public LibrariesController(MyLibraryV2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,LibraryName")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LibraryName")] Library library)
        {
            if (id != library.Id)
            {
                return NotFound();
